...
Necessary helm charts are created under `etc/k8s/locpoc` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
````powershell
127.0.0.1 web.locpoc.dev
127.0.0.1 locpoc.dev
127.0.0.1 authserver.locpoc.dev
127.0.0.1 identity.locpoc.dev
127.0.0.1 administration.locpoc.dev
127.0.0.1 product.locpoc.dev
127.0.0.1 saas.locpoc.dev
127.0.0.1 gateway-web.locpoc.dev
127.0.0.1 gateway-public.locpoc.dev
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `locpoc` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://locpoc-st-public-web for public and
   https://locpoc-st-web for the back-office application
