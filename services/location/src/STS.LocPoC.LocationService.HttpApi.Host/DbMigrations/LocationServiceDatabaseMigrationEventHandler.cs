...
using STS.LocPoC.Shared.Hosting.Microservices.DbMigrations;
using Volo.Abp.Data;
...
public class LocationServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<LocationServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public LocationServiceDatabaseMigrationEventHandler(
