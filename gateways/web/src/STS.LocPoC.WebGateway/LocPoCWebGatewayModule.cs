...
using STS.LocPoC.Shared.Hosting.Gateways;
using Swashbuckle.AspNetCore.SwaggerUI;
using Volo.Abp;
using Volo.Abp.Modularity;
using Yarp.ReverseProxy.Configuration;

namespace STS.LocPoC.WebGateway;

[DependsOn(
    typeof(LocPoCSharedHostingGatewaysModule)
)]
public class LocPoCWebGatewayModule : AbpModule
{
