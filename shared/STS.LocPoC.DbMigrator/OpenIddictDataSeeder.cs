...
public class OpenIddictDataSeeder : ITransientDependency
{
    ...
    private async Task CreateApiScopesAsync()
    {
        ...
        await CreateScopesAsync("LocationService");
    }

    private async Task CreateWebGatewaySwaggerClientsAsync()
    {
        await CreateSwaggerClientAsync("WebGateway",
            new[] { "AccountService", "IdentityService", "AdministrationService", "SaasService", "ProductService", "LocationService" });
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        await CreateApplicationAsync(
            ...
            scopes: commonScopes.Union(new[] {
                "AccountService", "IdentityService", "AdministrationService", "SaasService", "ProductService","LocationService"
            }).ToList(),
        ...
        await CreateApplicationAsync(
            ...
            scopes: commonScopes.Union(new[] { "AccountService", "AdministrationService", "ProductService", "LocationService" }).ToList(),
